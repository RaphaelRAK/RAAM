...
export const BIP39_WORDS = [
  ...
  'follow', 'food', 'foot', 'force', 'foreign', 'forest', 'forget', 'fork', 'fortune', 'forum',
  ...
  'pond', 'pony', 'pool', 'poor', 'popcorn', 'popular', 'portion', 'position', 'possible', 'post',
  ...
  'reopen', 'repair', 'repeat', 'replace', 'reply', 'report', 'require', 'rescue', 'resemble', 'resist',
  ...
  'ring', 'riot', 'rip', 'ripe', 'rise', 'risk', 'ritual', 'rival', 'river', 'road',
  ...
  'section', 'security', 'seed', 'seek', 'segment', 'seize', 'select', 'sell', 'seminar', 'senior',
  ...
  'weapon', 'weary', 'weather', 'web', 'wedding', 'weekend', 'weird', 'welcome', 'west', 'wet',
...
/**
 * Génère une phrase mnémonique de 12 mots à partir d'entropie
 */
