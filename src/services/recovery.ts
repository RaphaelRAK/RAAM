...
// Liste de mots BIP39 (simplifiée pour 12 mots)
const BIP39_WORDS = [
  ...
  "decide", "declare", "decline", "decorate", "decrease", "deer", "defense", "define",
  ...
  "peacock", "peak", "pear", "peasant", "pelican", "pen", "penalty", "pencil",
  ...
  "shoe", "shoot", "shop", "short", "shoulder", "shove", "shovel", "show",
  ...
  "stage", "stair", "stake", "stamp", "stand", "start", "state", "stay",
  ...
  "way", "wealth", "weapon", "weary", "weather", "web", "wedding", "weekend",
...
/**
 * Génère une clé de récupération de 12 mots (BIP39-like)
 */
export const generateRecoveryKey = (): string[] => {
  const words: string[] = [];
  const random = randomBytes(16); // 128 bits = 12 mots (128/11 ≈ 12)

  for (let i = 0; i < 12; i++) {
    const index = random[i] % BIP39_WORDS.length;
...
/**
 * Valide une clé de récupération
 */
